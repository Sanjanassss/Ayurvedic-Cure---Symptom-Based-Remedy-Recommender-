		...
		<header>
			...
			<nav>
				<ul>
					...
					<li><a href="AyurvediCure/ai-chat-bot.html">Talk with Ai</a></li>
		...
		<div class="menu">
			<!-- <div>
				<a href="aboutus.php"><img src="images/works.png" width="128" height="128">
					<div class="roll">About Us</div>
				</a>
			</div> -->
			<div>
				<a href="findadoc.php"><img src="images/find.png" width="128" height="128">
					<div class="roll">Find a Doctor</div>
				</a>
			</div>
			<div>
				<a href="profile.php"><img src="images/edit.png" width="128" height="128">
					<div class="roll">Profile</div>
				</a>
			</div>

			<div>
				<a href="connect.php"><img src="images/connect.png" width="128" height="128">
					<div class="roll">Contact Us</div>
				</a>
			</div>
			<div>
				<a href="./AyurvediCure/user-login.html"><img src="images/bot.png" width="128" height="128">
					<div class="roll">AI BOT</div>
				</a>
			</div>
		</div>
