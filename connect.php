		...
		<div class="menu">
			...
			<div class="query">
				<div class="move">
					...
					<div class="user">
						<strong>Faculty Name</strong>: Mr. Sreenivasa B R<br>
						<br>
						<strong>Contact Person</strong>: Admin <br>
						<strong>E-Mail Id</strong>: admin@pixelcount.net / <br>
						<strong>Level</strong>: 3rd Year<br>
						<strong>Major</strong>: Computer Science Engineering<br>
						<strong>College</strong>: BAPUJI INSTITUTE OF ENGINEERING AND TECHNOLOGY, Davangere.
					</div>
					<div class="delete">
					</div>
				</div>
